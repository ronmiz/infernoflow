...
export async function contextCommand(args) {
  ...
  if (cursorFlag) {
    ...
    console.log(green("  u2714 Written to .cursorrules u2014 Cursor loads this automatically"));
  }
  if (copilotFlag) {
    if (!fs.existsSync(".github")) fs.mkdirSync(".github");
    fs.writeFileSync(".github/copilot-instructions.md", contextMd, "utf8");
    console.log(green("  u2714 Written to .github/copilot-instructions.md u2014 Copilot loads this automatically"));
  }
