...
import { ensureClaudeAssets } from "./claudeAssets.mjs";
...
export function refreshRuleFilesFromMemory(cwd) {
  // Self-heal: install the shipped Claude skill/agent if a newer release
  // added them, so upgraders get them without re-running `init`. Silent + safe.
  ensureClaudeAssets(cwd);
