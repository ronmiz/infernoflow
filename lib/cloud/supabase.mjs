...
export const SUPABASE_URL      = process.env.INFERNOFLOW_SUPABASE_URL      || "https://YOUR_PROJECT.supabase.co";
export const SUPABASE_ANON_KEY = process.env.INFERNOFLOW_SUPABASE_ANON_KEY || "YOUR_ANON_KEY";
// ─────────────────────────────────────────────────────────────────────────────
 ...
 */
export async function pushEntry(entry, accessToken, projectId) {
  try {
    const row = {
