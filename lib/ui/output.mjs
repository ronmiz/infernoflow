...
// Evaluated per-call (not once at module load) so a late `process.env.NO_COLOR`
// — e.g. set by a `--no-color` CLI flag handler — is honored. Also respects a
// non-TTY stdout (piped/captured output) and the NO_COLOR convention.
