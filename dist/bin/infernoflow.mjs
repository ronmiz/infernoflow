...
`)}const w=Object.keys(d).length,E=`
  ...
  ${i("Memory")} ${e("\u2014 capture, recall & curate")}
    ...
    ${t("forget")}            Delete a bad entry ${e("(--last for the newest, or by id/prefix)")}
    ${t("prune")}             Archive stale notes/attempts ${e("(dry-run; --apply to commit)")}
